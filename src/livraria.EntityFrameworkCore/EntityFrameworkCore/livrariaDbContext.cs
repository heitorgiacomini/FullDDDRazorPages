...
public class livrariaDbContext :
    AbpDbContext<livrariaDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(livrariaConsts.DbTablePrefix + "Books",
        ...
        {
            b.ToTable(livrariaConsts.DbTablePrefix + "Authors",
                livrariaConsts.DbSchema);
        ...
        //{
        //    b.ToTable(livrariaConsts.DbTablePrefix + "YourEntities", livrariaConsts.DbSchema);
